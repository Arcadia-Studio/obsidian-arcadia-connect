...
var ArcadiaConnectSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("AI enrichment").setHeading();
    ...
    new import_obsidian2.Setting(containerEl).setName("AI provider").addDropdown(
      (dd) => dd.addOption("anthropic", "Anthropic").addOption("openai", "OpenAI").setValue(this.plugin.settings.aiProvider).onChange(async (value) => {
